...
Not a real package.
This is only used to a) demonstrate and b) verify the way [`dowdep-core`](../core) is referenced in companion TypeScript packages.
...
For this reason, this package even has its own [CI](/.github/workflows/example-ts.test.yml).
