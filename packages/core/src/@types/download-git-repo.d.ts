...
declare module 'download-git-repo' {
     ...
     */
    export default function download(repository: string, dest: string, options: Options, callback: (error?: Error | unknown) => void): void
    export default function download(repository: string, destination: string, callback: (error?: Error | unknown) => void): void
}
